...
export const addAppointment = async (appointmentData) => {
  try {
    ...
    console.error('[addAppointment] Error:', error.response?.data || error.message);
    throw error;
  }
};
export const getAllAppointments = async () => {
  try {
    ...
    console.error('[getAllAppointments] Error:', error.response?.data || error.message);
    throw error;
  }
};
...
export const checkDentistAvailability = async ({ dentistId, date, timeSlot, patientId }) => {
  console.log('[checkDentistAvailability] Checking with params:', { dentistId, date, timeSlot, patientId });
...
export const bookAppointment = (appointmentData) => api.post('/patient-portal/appointments', appointmentData);
export const getPatientAppointments = () => api.get('/patient-portal/appointments');
export const getPatientPrescriptions = () => api.get('/patient-portal/prescriptions');
...
// Medical Record APIs
export const getMedicalRecord = (patientId) => api.get(`/medical-records/${patientId}`);
export const updateMedicalRecord = (patientId, data) => api.put(`/medical-records/${patientId}`, data);
...
export const updatePatientSettings = (patientId, settings) => api.put(`/patient-portal/settings/${patientId}`, settings);
...
export const getTodayAppointments = async () => {
  try {
    ...
    console.error('[getTodayAppointments] Error:', error.response?.data || error.message);
    throw error;
  }
};
...
export const getAppointmentById = async (id) => {
  try {
    ...
    console.error('[getAppointmentById] Error:', error.response?.data || error.message);
    throw error;
  }
};
